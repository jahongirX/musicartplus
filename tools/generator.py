...
PHONE = '+7 903 102-16-40'
PHONE_HREF = '+79031021640'
...
TEACHERS = [
 ...
 dict(slug='belyakova', name='Белякова Анна Адольфовна', photo='belyakova.jpg',
      ...
      short='Рисунок, живопись, композиция. Ведёт художественное отделение школы.',
 ...
 dict(slug='goncharov', name='Гончаров Серафим', photo='goncharov.jpg',
      ...
      bio='Преподаватель по классу скрипки, ведёт группы раннего музыкального развития для детей с 3 до 6 лет. Урок построен на играх — ребёнок не устаёт и ждёт следующего занятия.',
      facts=['Выпускник Московской консерватории им. П. И. Чайковского','Преподаватель по классу скрипки','Детское музыкальное развитие, группы с 3 до 6 лет','Автор книги «Горизонты детства»'],
...
NEWS = [
 dict(slug='camp', d='12', m='августа', y='2026', tag='Жизнь школы', img='g15.jpg',
 ...
 dict(slug='concert', d='25', m='мая', y='2026', tag='Концерты', img='g07.jpg',
      title='Отчётный концерт учеников школы',
 ...
 dict(slug='open', d='06', m='апреля', y='2026', tag='Жизнь школы', img='g04.jpg',
      title='Открытый урок раннего музыкального развития',
      text='Показали родителям, как проходит занятие с малышами 3–6 лет: игры, ритмика, первые ноты.'),
 ...
 dict(slug='art', d='14', m='февраля', y='2026', tag='Жизнь школы', img='g02.jpg',
    ...
    <div class="footer__grid">
      <div>
        ...
        <div class="footer__fund">
          <span>При поддержке фонда <a href="''' + FUND + '''" target="_blank" rel="noopener">ФОРТЕФОРМА</a></span>
        </div>
      </div>
      <div>
        <h4>Разделы</h4>
      ...
      <div>
        ...
        <div class="footer__links">
          ...
          <a href="directions.html#dir-early">Раннее развитие 3–6 лет</a>
        </div>
      </div>
      <div>
        <h4>Контакты</h4>
...
DIRECTION_OPTIONS = ['Фортепиано','Скрипка','Труба и духовые','Вокал и сценическая речь',
 ...
 'Раннее музыкальное развитие (3–6 лет)','Подготовка к поступлению','Ещё не выбрали — подскажите']
    ...
    <div class="bk">
      <aside class="bk__aside">
        ...
        <ul class="about-list">
          ...
          <li><span class="tick">''' + ico('check') + '''</span><span>Заниматься можно на инструментах школы</span></li>
  ...
  <div class="container">
    <div class="sec-head">
      <div class="sec-head__text">
        ...
        <h2 class="h2">Мы <span class="brush">рядом с метро&nbsp;Минская</span></h2>
        <p class="sec-head__desc">Школа находится на закрытой территории — перед первым визитом позвоните, и мы встретим вас у входа.</p>
      </div>
    </div>
    <div class="contact-grid">
      <div class="contact-info">
        ...
        <div class="ci reveal" data-delay="3"><span class="ci__ico">''' + I['clock'] + '''</span>
          <div><b>Занятия</b><span>Очно в школе и онлайн</span>
          <small>Некоторые педагоги проводят занятия на дому</small></div></div>
      </div>
      <div class="map-wrap reveal reveal--right">
...
FACTS = [('11','педагогов и приглашённых артистов'),('8','направлений обучения'),('3+','возраст первых занятий, лет')]
facts_html = ''.join('<div class="hero-fact"><div class="hero-fact__num">' + n + '</div>'
                     '<div class="hero-fact__label">' + l + '</div></div>' for n, l in FACTS)

DIRS_HOME = [
 ('g07.jpg','Фортепиано','5+ лет','От первых нот до концертной программы — с педагогами высшей категории.'),
 ('g11.jpg','Скрипка и струнные','5+ лет','Постановка руки, интонация и первые ансамбли уже в первый год.'),
 ('g02.jpg','Живопись и рисунок','5+ лет','Рисунок, живопись, композиция — художественное отделение школы.'),
 ('g04.jpg','Раннее развитие','3–6 лет','Ритмика, слух и первые инструменты в форме игры.'),
]
dirs_html = ''
for i, (img, t, age, txt) in enumerate(DIRS_HOME):
    dirs_html += ('<a class="dir-card reveal" data-delay="' + str(i) + '" href="directions.html">'
      '<img src="assets/img/gallery/' + img + '" alt="' + t + '" loading="lazy" width="640" height="800">'
      '<div class="dir-card__body"><div class="dir-card__age">' + age + '</div>'
      '<h3 class="dir-card__title">' + t + '</h3>'
      '<p class="dir-card__text">' + txt + '</p></div></a>')

VIDEOS_HOME = [
 ('assets/video/promo.mp4','file','assets/video/promo-poster.jpg','Маленькие таланты','Ролик о школе · 40 сек'),
 ('https://rutube.ru/play/embed/1522631533be108e914109d0a930b5a4/','iframe','assets/img/guests/maklygin.jpg','Мастер-класс А. Л. Маклыгина','Теория музыки и импровизация'),
 ('assets/video/sign.mp4','file','assets/video/sign-poster.jpg','Как рождается наш почерк','Каллиграфия MusicArtPlus'),
]
vid_html = ''
...
<section class="hero">
  ...
  <div class="container hero__inner">
    <div class="hero__content">
      <span class="hero__eyebrow">''' + I['pin2'] + '''Центр искусств · Москва, м. Минская</span>
      <h1 class="hero__title" data-reveal-title>Место, где искра творчества зажигает звёзды</h1>
      <p class="hero__sub">Музыка, живопись и сцена для детей от 3 лет. Сильная академическая школа — в тёплой, живой атмосфере.</p>
  ...
  <div class="container">
    <div class="about-split">
      ...
      <div class="reveal reveal--right">
        <span class="eyebrow">О школе</span>
        <h2 class="h2">Мы учим не «правильно играть», а <span class="brush">слышать и чувствовать</span></h2>
        <p class="lead" style="margin-top:20px">MusicArtPlus — центр искусств в Москве, где дети от трёх лет знакомятся с музыкой, живописью и сценой. Мы соединяем крепкую академическую базу с современными методиками и авторскими программами для каждого ученика.</p>
        <ul class="about-list">
        ...
        <div class="flex-center mt-l" style="justify-content:flex-start">
          <a class="btn btn--dark" href="about.html">Подробнее о школе</a>
  ...
  <div class="container">
    <div class="sec-head">
      <div class="sec-head__text">
        ...
        <h2 class="h2">Чем живёт школа</h2>
...
<section class="section" id="directions">
  <div class="container">
    ...
    <div class="grid g-4">''' + dirs_html + '''</div>
  ...
  <div class="container">
    <div class="sec-head">
      <div class="sec-head__text">
        ...
        <h2 class="h2">Посмотрите, как это выглядит</h2>
        <p class="sec-head__desc">Ролики открываются прямо на сайте — без перехода на другие площадки.</p>
      </div>
...
STEPS = [
 ...
 ('Шаг 3','Регулярные занятия','Занятия проходят в школе или онлайн. Родители получают обратную связь: что получается, над чем работаем, что делать дома.'),
...
ABOUT = page_hero('О нас', 'Центр искусств, где ребёнку хочется остаться',
  'Музыка, живопись и сцена для детей от трёх лет. Мы соединяем академическую школу с живым, радостным обучением.',
  'g07.jpg') + '''
  ...
  <div class="container">
    <div class="about-split">
      <div class="reveal reveal--left">
        ...
        <h2 class="h2">Школа, построенная вокруг <span class="brush">ученика</span></h2>
...
<section class="section section--ink">
  <div class="container">
    <div class="about-split">
      <div class="reveal reveal--left">
        <span class="eyebrow" style="color:var(--gold)">Партнёр школы</span>
        <h2 class="h2">При поддержке фонда ФОРТЕФОРМА</h2>
        <p style="margin-top:18px;font-size:18px;line-height:1.65">Фонд поддерживает музыкальное образование и культурные проекты. Благодаря этому партнёрству в школе проходят мастер-классы приглашённых профессоров, концерты и творческие программы для детей.</p>
        <div class="flex-center mt-l" style="justify-content:flex-start">
...
<section class="section">
  <div class="container">
    <div class="sec-head">
      <div class="sec-head__text">
        <span class="eyebrow">Отзывы</span>
        <h2 class="h2">Родители — о школе</h2>
      </div>
...
''' + cta_band('Приходите знакомиться',
   'Мы подберём педагога, расскажем о программе и покажем школу. Пробное занятие — лучший способ понять, подходим ли мы друг другу.')
...
DIRECTIONS = [
 ...
 ('dir-art','palette','Изобразительное искусство','5+ лет','Рисунок, живопись, композиция и работа с разными материалами на художественном отделении школы.','Группа','60–90 мин'),
 ...
 ('dir-early','child','Раннее музыкальное развитие','3–6 лет','Ритмика, слушание, игры со звуком и знакомство с инструментами. Мягкий вход в музыку для самых маленьких.','Мини-группа','30–40 мин'),
]
dirs_page = ''
...
FAQ = [
 ...
 ('Нужно ли покупать инструмент сразу?','Нет, не обязательно. На первых занятиях можно заниматься на инструментах школы. После пробного периода мы поможем подобрать подходящий инструмент с учётом бюджета и потребностей.'),
  ...
  <div class="container">
    <div class="sec-head sec-head--center">
      <div class="sec-head__text">
        ...
        <h2 class="h2">Авторская методика школы</h2>
...
FULL = {
 ...
 'open': ['Мы пригласили родителей на открытый урок раннего музыкального развития, чтобы показать, как устроено занятие с малышами 3–6 лет.',
 ...
 'art': ['Художественное отделение школы объявляет набор. Занятия ведёт Анна Адольфовна Белякова — преподаватель и методист отделения, отмеченная почётными грамотами Министерства культуры РФ.',
         'В программе — рисунок, живопись, композиция и работа с разными материалами. Занятия проходят в мини-группах, инструменты и материалы есть в школе.'],
  ...
  <div class="container">
    <div class="cta-band reveal reveal--scale">
      ...
      <div>
        ...
        <p>Анонсы концертов, мастер-классов и наборов в группы мы публикуем в Telegram-канале школы.</p>
      </div>
      <div class="cta-band__actions">
...
def news_page(n, prev_n, next_n):
    ...
    body = (
        ...
        '<div class="container">'
          '<div class="sec-head">'
            '<div class="sec-head__text">'
              ...
              '<h2 class="h2">Другие новости школы</h2>'
            '</div>'
      ...
      + cta_band('Хотите так же?',
                 'Приходите на пробный урок — покажем школу, познакомим с педагогом и расскажем о программе.'))
