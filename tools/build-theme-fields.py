...
TEACHER = [
    ('Расписание', [
        f('hide_slots', 'Не показывать свободное время', 'true_false', ui=1, default_value=0,
          instructions='Блок со свободным временем в карточке этого педагога не появится — '
                       'например, если к нему не записывают через сайт.'),
