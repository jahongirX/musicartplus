...
<header class="header">
	<div class="container header__inner">
		<a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) . ' — ' . __( 'на главную', 'musicartplus' ) ); ?>">
			<img class="logo__dark" src="<?php echo esc_url( map_logo_url( 'color' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" width="176" height="103">
			<img class="logo__light" src="<?php echo esc_url( map_logo_url( 'white' ) ); ?>" alt="" aria-hidden="true" width="176" height="103">
		</a>
		...
		<div class="header__side">
			...
			<a class="btn btn--gold btn--sm"<?php echo map_cta_attrs(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- атрибуты экранируются внутри. ?>><?php echo esc_html( map_cta_label( true ) ); ?></a>
...
<div class="mobile-menu" id="mobile-menu">
	...
	<div class="mobile-menu__foot">
		<a class="btn btn--gold btn--block"<?php echo map_cta_attrs(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php echo esc_html( map_cta_label() ); ?></a>
