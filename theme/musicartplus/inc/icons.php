...
function map_icon( $name, $class = '' ) {
	...
	if ( null === $icons ) {
		$icons = array(
			...
			'trumpet'    => '<svg viewBox="0 0 24 24"><rect x="2.6" y="9.4" width="10.4" height="5.2" rx="1.6"/><path d="M13 9.8l6.6-3.4v11.2L13 14.2"/><path d="M6 9.4V7.2M9.4 9.4V7.2"/></svg>',
			...
			'violin'     => '<svg viewBox="0 0 24 24"><path d="M14.6 3.6l5.8 5.8M17.1 6.1l-8.4 8.4"/><path d="M9 12.6c-1.5-.6-3.1.3-3.9 1.7-.5.9-1.6 1-2.2 1.8-.9 1.1-.6 2.9.7 3.7 1.3.8 3.1.4 3.8-1 .4-.8.6-1.9 1.5-2.4 1.4-.8 2.2-2.5 1.4-3.8"/></svg>',
