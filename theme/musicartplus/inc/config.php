...
function map_defaults() {
	return array(
		...
		'slots_busy'   => 'На ближайшие дни свободного времени нет. Оставьте заявку — подберём удобное.',
		'slots_none'   => 'Время для записи к этому педагогу пока не добавлено. Оставьте заявку — мы перезвоним и подберём время.',
	);
}
