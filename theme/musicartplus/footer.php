...
<footer class="footer">
	...
	<div class="container">
		<div class="footer__grid">
			<div>
				<img class="footer__logo" src="<?php echo esc_url( map_asset( 'assets/img/ui/logo-white.png' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" width="176" height="103" loading="lazy">
				...
				<?php if ( map_opt( 'fund_url' ) ) : ?>
					<a class="footer__fund" href="<?php echo esc_url( map_opt( 'fund_url' ) ); ?>" target="_blank" rel="noopener">
						<img src="<?php echo esc_url( map_asset( 'assets/img/ui/forteforma.svg' ) ); ?>" alt="<?php echo esc_attr( sprintf( __( 'Фонд %s', 'musicartplus' ), map_opt( 'fund_name' ) ) ); ?>" width="45" height="34" loading="lazy">
						<span><?php esc_html_e( 'При поддержке фонда', 'musicartplus' ); ?> <b><?php echo esc_html( map_opt( 'fund_name' ) ); ?></b></span>
					</a>
				<?php endif; ?>
			</div>

			<div>
				<h4><?php esc_html_e( 'Разделы', 'musicartplus' ); ?></h4>
				<div class="footer__links"><?php map_footer_menu( 'footer' ); ?></div>
			</div>

			<div>
				<h4><?php esc_html_e( 'Направления', 'musicartplus' ); ?></h4>
				<div class="footer__links"><?php map_footer_directions(); ?></div>
			</div>

			<div>
				<h4><?php esc_html_e( 'Контакты', 'musicartplus' ); ?></h4>
		...
		<div class="footer__bottom">
			<span>&copy; <span data-year><?php echo esc_html( gmdate( 'Y' ) ); ?></span> <?php echo esc_html( get_bloginfo( 'name' ) ); ?>. <?php esc_html_e( 'Все права защищены.', 'musicartplus' ); ?></span>
			<span><?php map_privacy_links(); ?></span>
		</div>
	</div>
</footer>

<a class="btn btn--gold fab"<?php echo map_cta_attrs(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php esc_html_e( 'Записаться на пробный урок', 'musicartplus' ); ?></a>
